        ...
        <form method="POST" action="{{ route('admin.login') }}">
            ...
            <div class="mb-3">
                ...
                <div class="input-wrapper">
                    ...
                    <input type="email" class="form-control" name="email" placeholder="admin@gesa.id" required autofocus>
                </div>
            </div>
            ...
            <div class="mb-3">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('admin.forgot-password') }}" class="forgot-link mb-2">Lupa?</a>
                </div>
                <div class="input-wrapper">
