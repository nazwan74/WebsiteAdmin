...
<style>
    ...
    .blob-1 { width: 400px; height: 400px; background: #4361ee; top: -100px; right: -100px; }
    .blob-2 { width: 300px; height: 300px; background: #3f37c9; bottom: -50px; left: -50px; animation-delay: -5s; }
...
<div class="container-fluid py-4">
    ...
    <div class="row align-items-center mb-5">
        ...
        <div class="col-md-6 text-md-end mt-3 mt-md-0">
            <button class="btn btn-primary btn-premium shadow-sm" data-bs-toggle="modal" data-bs-target="#modalTambahAdmin">
                        ...
                        <tr>
                            <td class="ps-4 py-4">
                                <div class="d-flex align-items-center gap-3">
                                    <div class="bg-primary bg-opacity-10 text-primary rounded-circle d-flex align-items-center justify-content-center fw-bold shadow-sm" style="width: 48px; height: 48px; font-size: 1.1rem; border: 2px solid #fff;">
        ...
        <div class="modal-content modal-content-glass">
            <form method="POST" action="{{ route('admin.storeAdmin') }}">
                ...
                <div class="modal-body p-4">
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            <span class="input-group-text bg-white border-end-0 rounded-start-4"><i class="bi bi-envelope text-primary"></i></span>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            <span class="input-group-text bg-white border-end-0 rounded-start-4"><i class="bi bi-key-fill text-primary"></i></span>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="row g-3">
                            <div class="col-6">
                                ...
                                <label class="btn btn-outline-primary w-100 py-3" for="roleAdmin" style="border-radius: 16px;">
                            ...
                            <div class="col-6">
                                ...
                                <label class="btn btn-outline-indigo w-100 py-3" for="roleSuper" style="border-radius: 16px;">
                ...
                <div class="modal-footer border-0 p-4 pt-0">
                    ...
                    <button type="submit" class="btn btn-primary btn-premium flex-grow-1">Simpan Akun</button>
                </div>
            </form>
        </div>
    </div>
            ...
            button.addEventListener('click', function(e) {
                ...
                Swal.fire({
                    ...
                    customClass: {
                        ...
                        confirmButton: 'btn btn-danger btn-premium mx-2 px-4',
                        cancelButton: 'btn btn-light btn-premium mx-2 px-4'
                    },
